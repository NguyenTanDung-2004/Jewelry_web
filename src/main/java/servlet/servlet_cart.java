...
public class servlet_cart extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("buy")) {
            ...
            float point = total_money / (10000);
            // create pdf
            
            interact_with_user.update_point(point, user_id);
...
//          
            ...
            String total_format = format.format((double)total_money);
            create_pdf.create_project(interact_with_user.get_user_info_by_id(user_id).get(3) + "", phone, adrress + ", " + province + ", " + city + ", " + district, interact_with_orders.get_products_by_order_id(order_id), total_format);
            handle_email.send_email1(interact_with_user.get_user_info_by_id(user_id).get(3) + "", "Your Receipt", "Thank you for your order!", "C:\\Users\\user\\Downloads\\abc.pdf");
